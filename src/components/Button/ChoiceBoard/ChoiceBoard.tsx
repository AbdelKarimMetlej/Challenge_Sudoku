...
interface ChoiceBoardProps {
  setClickValue: (value: number) => void; // Function to handle the selected value
  selected: number; // The currently selected value
}

const CHOICES1 = [1, 2, 3, 4, 5];
const CHOICES2 = [6, 7, 8, 9];

const ChoiceBoard: React.FC<ChoiceBoardProps> = ({
  setClickValue,
  selected,
}) => {
  return (
